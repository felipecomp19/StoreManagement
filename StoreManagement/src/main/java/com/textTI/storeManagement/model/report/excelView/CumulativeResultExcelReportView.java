...
public class CumulativeResultExcelReportView extends AbstractExcelView {
	...
	private void setExcelRows(HSSFSheet excelSheet, HSSFCellStyle style, HSSFFont font, ExcelReportData reportData) {
		...
		for (Indicator indicator : reportData.getIndicators()) {
			...
			row.createCell(2).setCellValue(indicator.getWorkedDays());
			row.createCell(3).setCellValue(indicator.getGoal().toString());
			row.createCell(4).setCellValue(indicator.getValueOfSales().toString());
			row.createCell(5).setCellValue(indicator.getNumberOfAttendances());
			row.createCell(6).setCellValue(indicator.getNumberOfSales());
			row.createCell(7).setCellValue(indicator.getNumberOfItemsSold());
			row.createCell(8).setCellValue(indicator.getFormattedAchievementOfGoals());
			row.createCell(9).setCellValue(indicator.getAverageValueOfTheProduct().toString());
			row.createCell(10).setCellValue(indicator.getAverageTicket().toString());
			row.createCell(11).setCellValue(indicator.getItemsPerSale().toString());
			row.createCell(12).setCellValue(indicator.getFormattedConversionRate());
			row.createCell(13).setCellValue(indicator.getAverageSalesPerDay().toString());
		}
	...
	private void setExcelTotalsRow(HSSFSheet excelSheet, HSSFCellStyle style, HSSFFont font, ExcelReportData reportData, int rowTotalsNum) {
		...
		cell1.setCellValue("");
		cell2.setCellValue(indicator.getWorkedDays());
		cell3.setCellValue(indicator.getGoal().toString());
		cell4.setCellValue(indicator.getValueOfSales().toString());
		cell5.setCellValue(indicator.getNumberOfAttendances());
		cell6.setCellValue(indicator.getNumberOfSales());
		cell7.setCellValue(indicator.getNumberOfItemsSold());
		cell8.setCellValue(indicator.getFormattedAchievementOfGoals());
		cell9.setCellValue(indicator.getAverageValueOfTheProduct().toString());
		cell10.setCellValue(indicator.getAverageTicket().toString());
		cell11.setCellValue(indicator.getItemsPerSale().toString());
		cell12.setCellValue(indicator.getFormattedConversionRate());
		cell13.setCellValue(indicator.getAverageSalesPerDay().toString());
	}
}
